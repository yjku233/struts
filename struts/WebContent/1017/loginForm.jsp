...
<form name="myform" action="loginPro.action" method="post" onSubmit="return checkIt()">
<TABLE cellSpacing=1 cellPadding=1 width="260" border=1 align="center" >
  ...
  <TR height="30">
    <TD colspan="2" align="middle" bgcolor="${title_c}" >
      ...
      <input type="button" value="회원가입" onclick="javascript:window.location='inputForm.action'"></TD></TR>
</TABLE>
</form>
